...
local get_player_settings = require("util.settings").get_player_settings
...
local function on_confirm_click(e, self, tdata)
    if tdata.settings.show_tiles then
        painter.paint_tiles(tdata.tiles, game.surfaces[tdata.surface], tdata.tile_type, self.player)
    else
