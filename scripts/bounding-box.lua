...
---@param box BoundingBox | BoundingBox4
---@return BoundingBox4
...
--- shrink it.
---@param box   BoundingBox Must be an explicit bounding box
---@param delta number
---@return BoundingBox
...
---@param box  BoundingBox The bounding box or rectangle, Must be an Axis Aligned Bounding Box
function tp_bounding_box.line_intersect_AABB(pos1, pos2, box)
    ...
    -- Ensure explicit above
    local l, t, r, b = area.left_top.x --[[@as double]], area.left_top.y --[[@as double]], area.right_bottom.x --[[@as double]], area.right_bottom.y
    local x1, y1, x2, y2 = pos1.x --[[@as double]], pos1.y --[[@as double]], pos2.x --[[@as double]], pos2.y
    ---@diagnostic disable-next-line: need-check-nil
    -- normalize segment
